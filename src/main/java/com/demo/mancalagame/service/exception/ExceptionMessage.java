...
public final class ExceptionMessage {
    ...
    public static final String GAME_ALREADY_FINISHED = "The specified game is already finished. Please try to start a new one.";
    ...
    public static final String EMPTY_PIT = "The specified pit is empty. Please select a pit that contains stones.";
}
